...
const turmaA = ['Barry', 'Iris', 'Nora'];
const turmaB = ['JoeWest', ...turmaA, 'Cisco', 'HarrisonWells'];
console.log(turmaB);
...
// Exercicio 2
const dizerOla = function (nome = "Fulano") {
